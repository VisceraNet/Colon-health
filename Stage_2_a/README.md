...
High specificity for severe classes reduces false positives

Lower sensitivity for Mayo_3 reflects clinical difficulty and class imbalance

Performance follows the expected ordinal severity trend
